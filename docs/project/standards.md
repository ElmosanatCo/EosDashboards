...
- Place a shared help icon in the upper-left corner of every workspace page, including authorized form pages. Open a readable page-specific modal with the fixed sections `وظایف این صفحه`, `امکانات`, `شیوه انجام کار`, and `محدودیت‌ها`; keep the content truthful to the approved stage and update it when the related capability changes.
