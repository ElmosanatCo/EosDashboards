...
- Require an explicit Persian confirmation before every user-visible delete, removal, archive, or deactivation action. The confirmation must identify the target and action; cancel, close, and backdrop dismissal must leave state unchanged and must not send a mutation request. Non-destructive reactivation may remain immediate.
