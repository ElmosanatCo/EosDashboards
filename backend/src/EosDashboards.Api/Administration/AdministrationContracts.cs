...
public sealed record CreateUserRequest(string PersonnelCode, string AccountName, string FirstName, string LastName, string Mobile, string? Username, string TemporaryPassword, long DepartmentId, long[] RoleIds)
{ public override string ToString() => nameof(CreateUserRequest); }
public sealed record UpdateUserRequest(string PersonnelCode, string AccountName, string FirstName, string LastName, string? ReplacementMobile, string Username, long DepartmentId, long[] RoleIds, string RowVersion)
...
public sealed record ManagedUserResponse(long Id, string PersonnelCode, string AccountName, string FirstName, string LastName, string? Username, string MaskedMobile, long DepartmentId, bool IsActive, bool MustChangePassword, long[] RoleIds, string RowVersion);
